...
<head>
    ...
    <script>
        ...
        function search(table_no,cate_bar_seq){
            ...
            //숙소유형
            let type = $("input[name=house_type]:selected")
            //침실과침대
            let bed = $("select[name=bed_select] option:selected")
            let bedroom = $("select[name=bedroom_select] option:selected")
            let bathroom = $("select[name=bathroom_select] option:selected")
            //건물유형
            let sort
            //편의시설 seq리스트
            ...
            //슈퍼호스트
            let superhost = $("input[name=superhost]:checked")
            //언어 seq리스트
            chk_lang = new Array();
    ...
    <section>
        ...
        <div class="filter_popup">            
            ...
            <div class="super_host filter_block">
                ...
                <input type="radio" name="superhost" id="superhost_on" checked>
                <label for="superhost_on">OFF</label>
                <input type="radio" name="superhost" id="superhost_off">
