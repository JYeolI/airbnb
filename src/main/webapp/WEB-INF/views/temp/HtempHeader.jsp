...
<head>
    ...
    <style>
        ...
        .member_info_button {cursor: pointer; border-radius: 30px; border: 1px solid #ccc; margin: 10px;}
        .member_info_button:hover {cursor: pointer; box-shadow: 1px 1px 5px #ccc; background-color: #fff; border-radius: 30px;}
