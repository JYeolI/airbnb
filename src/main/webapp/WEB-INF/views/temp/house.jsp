        ...
        $(function(){
            $.ajax({
                ...
                success:function(r){
                    ...
                    //섹션 메인
                    let house_title = r.houseDeatil.house_name
                    $(".house_title").html(house_title);
                    let house_address = r.houseDeatil.house_country +","+ r.houseDeatil.house_city +","+ r.houseDeatil.house_address;
                    ...
                    $(".guest").html(r.houseDeatil.house_guest);
                    $(".bedroom").html(r.houseDeatil.house_bedroom);
                    $(".bed").html(r.houseDeatil.house_bed);
                    $(".bathroom").html(r.houseDeatil.house_bathroom);
                    let desc_title = r.houseDeatil.host_name + " 님이 호스팅하는 " + r.houseDeatil.house_sort_detail;
                    let desc_content = r.houseDeatil.house_description;
                    $(".desc_title").html(desc_title);
                    $(".desc_content").html(desc_content);

                    //섹션 숙박장소
                    let bed = r.houseDeatil.house_bed;
                    let bedroom = r.houseDeatil.house_bedroom;
                    let lastroom = r.houseDeatil.house_lastroom;
                    let bathroom = r.houseDeatil.house_bathroom;
                    ...
                    $(".host_name").html(r.houseDeatil.host_name);
                    let hose_profile_tag = 
                    '<a href="http://localhost:7777/profile?member_seq=1">'+
                        '<div class="profile_img" style="background-image: url(/img/member/'+r.houseDeatil.host_img+');"></div>'+
                    '</a>';
                    $(".host_img").append(hose_profile_tag);
                    $(".reg_dt").html(r.houseDeatil.host_reg_dt);
                    let rev_cnt = r.houseDetailCnt.house_review_cnt;
                    if(rev_cnt==null) rev_cnt=0;
                    $(".rev_cnt").html(rev_cnt);
                    $(".host_desc").html(r.houseDeatil.host_description);
                    ...
                    //환불정책 ##백에서 계산해서 내주기
                    $(".refund_dt").html(r.houseDeatil.house_refund_day);
